...
func (c *client.Client) ConsoleForgotPassword(ctx context.Context, req *ForgotPasswordRequest) (*ForgotPasswordResponse, error) {
	var result ForgotPasswordResponse
	err := c.sendRequest(ctx, "POST", "/console/api/forgot-password", req, &result, nil)
	if err != nil {
		return nil, err
	}
	return &result, nil
...
func (c *client.Client) ConsoleCheckForgotPasswordCode(ctx context.Context, req *CheckForgotPasswordCodeRequest) (*CheckForgotPasswordCodeResponse, error) {
	var result CheckForgotPasswordCodeResponse
	err := c.sendRequest(ctx, "POST", "/console/api/forgot-password/validity", req, &result, nil)
	if err != nil {
		return nil, err
	}
	return &result, nil
...
func (c *client.Client) ConsoleResetPassword(ctx context.Context, req *ResetPasswordRequest) (*ResetPasswordResponse, error) {
	var result ResetPasswordResponse
	err := c.sendRequest(ctx, "POST", "/console/api/forgot-password/resets", req, &result, nil)
	if err != nil {
		return nil, err
	}
	return &result, nil
